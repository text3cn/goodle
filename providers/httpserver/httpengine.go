...
// 注册全局中间件
func (this *GoodleEngine) UseMiddleware(handlers ...RequestHandler) {
...
func (this *GoodleEngine) AddRoute(methoad, prefix, uri string, routeType int8, handlers ...RequestHandler) {
