...
// 因为注册是全局一次性的，而获取服务是业务场景中频繁获取的，所以 T3WebEngine 负责注册服务，Context 负责获取服务
// 跟 http 路由一样，服务中心时为服务提供注册、初始化、路由功能
type Container interface {
	// 绑定一个服务提供者，如果服务名称已经存在，会进行替换操作，返回error
...
// 按断是否有服务提供者数据结构，如果服务提供者没有把自己的数据结构传递到容器那还实例化个锤子
